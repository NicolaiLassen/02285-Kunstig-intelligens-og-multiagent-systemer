...
public class State {
    ...
    */
    ...
    private boolean isApplicable(int agent, Action action) {
        ...
        switch (action.type) {
            ...
            case Push:
                ...
                // of the same color
                box = this.boxes[boxRow][boxCol];
                if (agentColor != boxColors[colorIndexFromNumericChar(box)]) {
                    return false;
                }
            ...
            case Pull:
                ...
                // of the same color
                box = this.boxes[boxRow][boxCol];
                return agentColor == boxColors[colorIndexFromNumericChar(box)];
        }
    ...
    private int colorIndexFromNumericChar(char c) {
